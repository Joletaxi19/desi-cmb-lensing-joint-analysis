# Stolen from: https://github.com/martin-marek/mini-hmc-jax
import jax
import jax.numpy as jnp


def leapfrog(params, momentum, log_prob_fn, grad_log_prob_fn, step_size, n_steps):
...
def hmc_sampler(params, log_prob_fn, grad_log_prob_fn, n_steps, n_leapfrog_steps, step_size, key):
    """
    ...
    def step(i, args):
        ...
        # leapfrog
        new_params, new_momentum = leapfrog(params, momentum, log_prob_fn, grad_log_prob_fn, step_size, n_leapfrog_steps)
